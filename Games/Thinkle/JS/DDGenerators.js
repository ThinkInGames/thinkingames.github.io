...
function setAtrributes(aStr, aAlg, div){
    document.getElementById(div).setAttribute("stringData",aStr)
    document.getElementById(div).setAttribute("data",aAlg)    
}
function setDropAns(l){
    switch(l){
        case 1: case 5:
            var a = Math.floor((Math.random() * 5) + 3)+"* x"
            printQuestion(a)
            printDrags()
            for(var i = 1; i<5; i++){
                var div  = "div"+i
        ...
        break
        case 4:
            var a = Math.floor((Math.random() * 7) + 1)+"* x"
            printQuestion(a)
            printDrags()
            for(var i = 1; i<5; i++){
                var div = "div"+i
        ...
        break 
        case 7: case 8:
            var a = Math.floor((Math.random() *20) + 20)+"* x"
            printQuestion(a)
            printDrags()
            for(var i = 1; i<5; i++){
                var div = "div"+i
        ...
        case 19:
            var sign = Math.random() < 0.5 ? -1 : 1;
            var a =sign* Math.floor((Math.random() *30) + 1)+"* x"
            printQuestion(a)
            printDrags()
            for(var i = 1; i<5; i++){
                var div = "div"+i
...
function printQuestion(aStr){
    ...
    katex.render(document.getElementById("question").getAttribute("data"),question);
}